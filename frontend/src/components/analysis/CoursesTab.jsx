import { ArrowRight, Check, GraduationCap, Lightbulb } from 'lucide-react';import { pill, PLATFORM_STYLES, detectPlatform } from './analysisUtils';const CoursesTab = ({ courses, recommendedSkills, targetRole }) => {
