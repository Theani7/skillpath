import { Check, CheckCircle, Circle, ListChecks, Search, XCircle } from 'lucide-react';

const SkillsTab = ({ matched, gaps, filter, setFilter, roleSkills, targetRole }) => {
  const filterMatch = (s) => {
  ...
  // Build unified skill list for "all role skills" view
