...
import { fadeUp, stagger } from './analysisUtils';
...
const EmptyState = ({ onUpload }: EmptyStateProps) => (
  ...
  >
    <motion.div variants={fadeUpVariants} className="analysis-empty-state-icon">
      <FileText size={32} color="var(--color-primary)" />
    </motion.div>
    <motion.h2 variants={fadeUpVariants} className="analysis-empty-state-title">
      No analysis yet
    </motion.h2>
    <motion.p variants={fadeUpVariants} className="analysis-empty-state-text">
