...
const SecurityCard = ({ passwordForm, setPasswordForm, passwordErrors, passwordLoading, showCurrentPassword, setShowCurrentPassword, showNewPassword, setShowNewPassword, handlePasswordChange }: Props) => (
  <Section
    icon={Lock}
    title="Security"
