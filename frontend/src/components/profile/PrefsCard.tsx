...
type Props = {
  ...
  prefsDraft: UserPreferences;
  editingPrefs: boolean;
  savingPrefs: boolean;
  setEditingPrefs: (v: boolean) => void;
  setPrefsDraft: (v: UserPreferences) => void;
  handleSavePrefs: () => void;
};

const PrefsCard = ({ preferences, prefsDraft, editingPrefs, savingPrefs, setEditingPrefs, setPrefsDraft, handleSavePrefs }: Props) => (
  <motion.div
      ...
      {editingPrefs ? (
        ...
        >
          <EditableField
            ...
            onChange={(v: string) => setPrefsDraft({ ...prefsDraft, target_role: v })}
            placeholder="e.g., Senior Frontend Engineer"
          />
          <EditableField
            label="Preferred Location" icon={MapPin}
            value={prefsDraft.preferred_location}
            onChange={(v: string) => setPrefsDraft({ ...prefsDraft, preferred_location: v })}
